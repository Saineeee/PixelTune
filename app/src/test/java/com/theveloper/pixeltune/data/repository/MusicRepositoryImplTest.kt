...
import com.theveloper.pixeltune.data.database.SongEntity // Necesario para datos de prueba
import com.theveloper.pixeltune.data.database.AlbumEntity
import com.theveloper.pixeltune.data.database.ArtistEntity
import com.theveloper.pixeltune.data.model.Song // Para verificar el mapeo
...
class MusicRepositoryImplTest {
    ...
    private val mockTelegramCacheManager: com.theveloper.pixeltune.data.telegram.TelegramCacheManager = mockk(relaxed = true)
    private val mockTelegramRepository: com.theveloper.pixeltune.data.telegram.TelegramRepository = mockk(relaxed = true)
