package com.theveloper.pixeltune.data.backup

import android.content.Context
import android.net.Uri
import android.os.Build
import com.theveloper.pixeltune.data.backup.format.BackupReader
import com.theveloper.pixeltune.data.backup.format.BackupWriter
import com.theveloper.pixeltune.data.backup.history.BackupHistoryRepository
import com.theveloper.pixeltune.data.backup.model.BackupHistoryEntry
import com.theveloper.pixeltune.data.backup.model.BackupManifest
...
import com.theveloper.pixeltune.data.backup.model.BackupValidationResult
import com.theveloper.pixeltune.data.backup.model.DeviceInfo
import com.theveloper.pixeltune.data.backup.model.RestorePlan
import com.theveloper.pixeltune.data.backup.model.RestoreResult
import com.theveloper.pixeltune.data.backup.module.BackupModuleHandler
import com.theveloper.pixeltune.data.backup.restore.RestoreExecutor
import com.theveloper.pixeltune.data.backup.restore.RestorePlanner
import com.theveloper.pixeltune.data.backup.validation.ValidationPipeline
...
class BackupManager @Inject constructor(
    ...
    suspend fun export(
        ...
        runCatching {
            ...
            reportProgress(onProgress, BackupOperationType.EXPORT, ++step, totalSteps,
                "Backup complete", "Your PixelTune backup was created successfully.")
        }
    }
