package com.theveloper.pixeltune.data.repository
...
interface MusicRepository {
     ...
     */
    fun getPaginatedSongs(sortOption: com.theveloper.pixeltune.data.model.SortOption, storageFilter: com.theveloper.pixeltune.data.model.StorageFilter): Flow<PagingData<Song>>
    ...
    fun getPaginatedFavoriteSongs(
        sortOption: com.theveloper.pixeltune.data.model.SortOption,
        storageFilter: com.theveloper.pixeltune.data.model.StorageFilter = com.theveloper.pixeltune.data.model.StorageFilter.ALL
     ...
     */
    fun getAlbums(storageFilter: com.theveloper.pixeltune.data.model.StorageFilter = com.theveloper.pixeltune.data.model.StorageFilter.ALL): Flow<List<Album>> // Existing Flow for reactive updates
     ...
     */
    fun getGenres(): Flow<List<com.theveloper.pixeltune.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.theveloper.pixeltune.data.model.StorageFilter = com.theveloper.pixeltune.data.model.StorageFilter.ALL
    ): Flow<List<com.theveloper.pixeltune.data.model.MusicFolder>>
    ...
    val telegramRepository: com.theveloper.pixeltune.data.telegram.TelegramRepository

    suspend fun getSongIdsSorted(
        sortOption: com.theveloper.pixeltune.data.model.SortOption,
        storageFilter: com.theveloper.pixeltune.data.model.StorageFilter
    ): List<Long>
}
