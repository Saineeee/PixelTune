package com.theveloper.pixeltune
...
import com.theveloper.pixeltune.presentation.components.AllFilesAccessDialog
import com.theveloper.pixeltune.presentation.components.AppSidebarDrawer
import com.theveloper.pixeltune.presentation.components.CrashReportDialog
import com.theveloper.pixeltune.presentation.components.DismissUndoBar
import com.theveloper.pixeltune.presentation.components.DrawerDestination
...
import com.theveloper.pixeltune.presentation.screens.SetupScreen
import com.theveloper.pixeltune.presentation.viewmodel.MainViewModel
import com.theveloper.pixeltune.presentation.viewmodel.PlayerViewModel
import com.theveloper.pixeltune.ui.theme.PixelTuneTheme
import com.theveloper.pixeltune.utils.CrashHandler
...
import com.theveloper.pixeltune.presentation.utils.AppHapticsConfig
import com.theveloper.pixeltune.presentation.utils.LocalAppHapticsConfig
import com.theveloper.pixeltune.presentation.utils.NoOpHapticFeedback
import com.theveloper.pixeltune.utils.CrashLogData
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleIntent(intent: Intent?) {
        ...
        when {
            ...
            intent.action == "com.theveloper.pixeltune.ACTION_PLAY_SONG" -> {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                     intent.getParcelableExtra("song", com.theveloper.pixeltune.data.model.Song::class.java)?.let { song ->
                         playerViewModel.playSong(song)
                     }
                } else {
                     @Suppress("DEPRECATION")
                     intent.getParcelableExtra<com.theveloper.pixeltune.data.model.Song>("song")?.let { song ->
                         playerViewModel.playSong(song)
                     }
                }
                intent.action = null
    ...
    companion object {
        const val ACTION_SHUFFLE_ALL = "com.theveloper.pixeltune.ACTION_SHUFFLE_ALL"
        const val ACTION_OPEN_PLAYLIST = "com.theveloper.pixeltune.ACTION_OPEN_PLAYLIST"
                ...
                onDestinationSelected = { destination ->
                    ...
                    when (destination) {
                        ...
                        DrawerDestination.Telegram -> {
                            val intent = Intent(this@MainActivity, com.theveloper.pixeltune.presentation.telegram.auth.TelegramLoginActivity::class.java)
                            startActivity(intent)
                        }
                        else -> {}
                    }
