...
object PlayerActions {
    ...
    const val PLAY_PAUSE = "com.example.PixelTune.ACTION_WIDGET_PLAY_PAUSE"
    const val NEXT = "com.example.PixelTune.ACTION_WIDGET_NEXT"
    const val PREVIOUS = "com.example.PixelTune.ACTION_WIDGET_PREVIOUS"
    const val FAVORITE = "com.example.PixelTune.ACTION_WIDGET_FAVORITE"
    const val PLAY_FROM_QUEUE = "com.example.PixelTune.ACTION_WIDGET_PLAY_FROM_QUEUE"
    const val SHUFFLE = "com.example.PixelTune.ACTION_WIDGET_SHUFFLE"
    const val REPEAT = "com.example.PixelTune.ACTION_WIDGET_REPEAT"
}
