...
import com.theveloper.pixeltune.data.model.QueueItem
import com.theveloper.pixeltune.utils.createScalableBackgroundBitmap
import timber.log.Timber

class PixelTuneGlanceWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        provideContent {
            ...
            Timber.tag("PixelTuneGlanceWidget")
    ...
    private fun WidgetUi(
        ...
        val title = playerInfo.songTitle.ifEmpty { "PixelTune" }
