...
object WidgetPlayerActions {
    const val PLAY_PAUSE = "com.theveloper.pixeltune.PLAY_PAUSE"
    const val NEXT = "com.theveloper.pixeltune.NEXT"
    const val PREVIOUS = "com.theveloper.pixeltune.PREVIOUS"
