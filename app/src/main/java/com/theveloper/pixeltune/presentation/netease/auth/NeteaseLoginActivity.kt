package com.theveloper.pixeltune.presentation.netease.auth
    ...
    Scaffold(
        ...
        Column(
            ...
            ElevatedCard(
                ...
                Text(
                    text = "Security note: your password is entered only in NetEase web pages. PixelTune stores session cookies (MUSIC_U) to sync your library.",
