...
import com.theveloper.pixeltune.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.theveloper.pixeltune.presentation.viewmodel.StablePlayerState>
    ) {
