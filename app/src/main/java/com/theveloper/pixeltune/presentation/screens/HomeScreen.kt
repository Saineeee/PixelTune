...
import com.theveloper.pixeltune.presentation.components.HomeOptionsBottomSheet
...
import com.theveloper.pixeltune.presentation.components.RecentlyPlayedSection
import com.theveloper.pixeltune.presentation.components.RecentlyPlayedSectionMinSongsToShow
import com.theveloper.pixeltune.presentation.components.SmartImage
import com.theveloper.pixeltune.presentation.components.StatsOverviewCard
...
import com.theveloper.pixeltune.presentation.components.StreamingProviderSheet
...
import com.theveloper.pixeltune.presentation.viewmodel.StatsViewModel
        ...
        Scaffold(
            ...
            topBar = {
                HomeGradientTopBar(
                    ...
                    onMoreOptionsClick = {
                        // IMPROVE(listening-history): the history button now opens a
                        // stretchable FULL-SCREEN page instead of the old cramped
                        // ModalBottomSheet.
                        navController.navigateSafely(Screen.ListeningHistory.route)
                    },
                    onBetaClick = {
