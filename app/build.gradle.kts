...
android {
    ...
    // kotlinCompilerExtensionVersion is intentionally not set: the Compose
    // Compiler Gradle plugin (org.jetbrains.kotlin.plugin.compose, applied
    // above) supplies the compiler extension matching the Kotlin version.
    buildFeatures {
        compose = true
        buildConfig = true
    }
