...
# Without these, R8 full-mode can strip reflection-reached classes and
# YouTube/SoundCloud playback fails ONLY in release builds (debug works).
-keep class org.schabi.newpipe.** { *; }
-keep interface org.schabi.newpipe.** { *; }
-dontwarn org.schabi.newpipe.**

# Rhino JS engine — executes YouTube's signature-decipher JavaScript at runtime.
# Heavy internal reflection; must be fully kept or stream URLs fail to decrypt.
-keep class org.mozilla.javascript.** { *; }
-keep class org.mozilla.classfile.** { *; }
-keepclassmembers class org.mozilla.javascript.** { *; }
-dontwarn org.mozilla.**

# nanojson — NewPipeExtractor's JSON parser
-keep class com.grack.nanojson.** { *; }
-dontwarn com.grack.nanojson.**

# jsoup — HTML parsing used by NewPipeExtractor & playlist import scraping
-dontwarn org.jsoup.**
